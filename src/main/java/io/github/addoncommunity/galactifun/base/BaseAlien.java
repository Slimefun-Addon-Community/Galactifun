...
public final class BaseAlien {
    ...
    public static final Firestorm FIRESTORM = new Firestorm("FIRESTORM", "火焰风暴", 40, 10);
    public static final MutantCreeper MUTANT_CREEPER = new MutantCreeper("MUTANT_CREEPER", "突变苦力怕", 40, 5);
    ...
    public static final TitanAlien TITAN = new TitanAlien("TITAN", "泰坦星人", 32, 5);
