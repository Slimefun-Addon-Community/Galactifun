...
/**
 * An immutable 3-dimensional vector. This was taken from WorldEdit. All credit goes to the
 * WorldEdit team
 *
...
public final class BlockVector3 {
    ...
    public static BlockVector3 fromLocation(Location l) {
        return at(l.getBlockX(), l.getBlockY(), l.getBlockZ());
    }
    ...
    public static BlockVector3 fromLongPackedForm(long packed) {
        return at(BitMath.unpackX(packed), BitMath.unpackY(packed), BitMath.unpackZ(packed));
    }
    ...
    /**
     * This was taken from WorldEdit. All credit goes to the WorldEdit team
     *
     * @author WorldEdit team
     */
    private static final class BitMath {
